-- Baseline historical database for Shogun.
-- This migration is intentionally the first supported database version.
-- Older local databases, seeds, and schema snapshots are not supported.
...
-- Source-backed import migration fragment generated from the MIT-licensed
-- fthux/Characters_of_the_Three_Kingdoms character JSON corpus.
--
-- Rebuild with:
--   rtk cargo run --bin import_three_kingdoms -- <source-characters-dir> /tmp/ctk_import_fragment.sql
