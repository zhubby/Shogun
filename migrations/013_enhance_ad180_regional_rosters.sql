...
(source_officer_id, target_officer_id, relationship_kind, confidence, notes, source)
VALUES
('cao_cao', 'cao_ang', 'ParentChild', 'High', '曹昂为曹操长子。', 'manual_curated'),
('cao_ang', 'cao_cao', 'ParentChild', 'High', '曹昂为曹操长子。', 'manual_curated'),
('cao_cao', 'cao_zhang', 'ParentChild', 'High', '曹彰为曹操之子。', 'manual_curated'),
('cao_zhang', 'cao_cao', 'ParentChild', 'High', '曹彰为曹操之子。', 'manual_curated'),
('cao_cao', 'cao_zhi', 'ParentChild', 'High', '曹植为曹操之子。', 'manual_curated'),
('cao_zhi', 'cao_cao', 'ParentChild', 'High', '曹植为曹操之子。', 'manual_curated'),
('cao_cao', 'cao_chong', 'ParentChild', 'High', '曹冲为曹操之子。', 'manual_curated'),
('cao_chong', 'cao_cao', 'ParentChild', 'High', '曹冲为曹操之子。', 'manual_curated'),
('cao_pi', 'cao_rui', 'ParentChild', 'High', '曹叡为曹丕之子。', 'manual_curated'),
('cao_rui', 'cao_pi', 'ParentChild', 'High', '曹叡为曹丕之子。', 'manual_curated'),

('sun_jian', 'sun_yi', 'ParentChild', 'High', '孙翊为孙坚之子。', 'manual_curated'),
('sun_yi', 'sun_jian', 'ParentChild', 'High', '孙翊为孙坚之子。', 'manual_curated'),
('sun_jian', 'sun_kuang', 'ParentChild', 'High', '孙匡为孙坚之子。', 'manual_curated'),
('sun_kuang', 'sun_jian', 'ParentChild', 'High', '孙匡为孙坚之子。', 'manual_curated'),
('sun_jian', 'sun_lang', 'ParentChild', 'Medium', '孙朗为孙坚庶子。', 'manual_curated'),
('sun_lang', 'sun_jian', 'ParentChild', 'Medium', '孙朗为孙坚庶子。', 'manual_curated'),
('sun_quan', 'sun_deng', 'ParentChild', 'High', '孙登为孙权长子。', 'manual_curated'),
('sun_deng', 'sun_quan', 'ParentChild', 'High', '孙登为孙权长子。', 'manual_curated'),
('sun_quan', 'sun_he', 'ParentChild', 'High', '孙和为孙权之子。', 'manual_curated'),
('sun_he', 'sun_quan', 'ParentChild', 'High', '孙和为孙权之子。', 'manual_curated'),
('sun_quan', 'sun_ba', 'ParentChild', 'High', '孙霸为孙权之子。', 'manual_curated'),
('sun_ba', 'sun_quan', 'ParentChild', 'High', '孙霸为孙权之子。', 'manual_curated'),
('sun_quan', 'sun_liang', 'ParentChild', 'High', '孙亮为孙权之子。', 'manual_curated'),
('sun_liang', 'sun_quan', 'ParentChild', 'High', '孙亮为孙权之子。', 'manual_curated'),
('sun_quan', 'sun_xiu', 'ParentChild', 'High', '孙休为孙权之子。', 'manual_curated'),
('sun_xiu', 'sun_quan', 'ParentChild', 'High', '孙休为孙权之子。', 'manual_curated'),
('sun_he', 'sun_hao', 'ParentChild', 'High', '孙皓为孙和之子。', 'manual_curated'),
('sun_hao', 'sun_he', 'ParentChild', 'High', '孙皓为孙和之子。', 'manual_curated'),

('liu_bei', 'liu_feng', 'AdoptiveParentChild', 'High', '刘封为刘备养子。', 'manual_curated'),
('liu_feng', 'liu_bei', 'AdoptiveParentChild', 'High', '刘封为刘备养子。', 'manual_curated'),
('liu_bei', 'liu_yong', 'ParentChild', 'High', '刘永为刘备之子。', 'manual_curated'),
('liu_yong', 'liu_bei', 'ParentChild', 'High', '刘永为刘备之子。', 'manual_curated'),
('liu_bei', 'liu_li', 'ParentChild', 'High', '刘理为刘备之子。', 'manual_curated'),
('liu_li', 'liu_bei', 'ParentChild', 'High', '刘理为刘备之子。', 'manual_curated'),

('guan_yu', 'guan_ping', 'ParentChild', 'Medium', '关平为关羽子嗣或义子形象。', 'manual_curated'),
('guan_ping', 'guan_yu', 'ParentChild', 'Medium', '关平为关羽子嗣或义子形象。', 'manual_curated'),
('guan_yu', 'guan_xing', 'ParentChild', 'High', '关兴为关羽之子。', 'manual_curated'),
('guan_xing', 'guan_yu', 'ParentChild', 'High', '关兴为关羽之子。', 'manual_curated'),
('guan_yu', 'guan_suo', 'ParentChild', 'Medium', '关索为关羽传说子嗣。', 'manual_curated'),
('guan_suo', 'guan_yu', 'ParentChild', 'Medium', '关索为关羽传说子嗣。', 'manual_curated'),
('guan_yu', 'guan_yinping', 'ParentChild', 'Medium', '关银屏为关羽之女的民间形象。', 'manual_curated'),
('zhang_fei', 'empress_zhang_jingai', 'ParentChild', 'High', '敬哀皇后张氏为张飞长女。', 'manual_curated'),
('empress_zhang_jingai', 'zhang_fei', 'ParentChild', 'High', '敬哀皇后张氏为张飞长女。', 'manual_curated'),
('zhang_fei', 'empress_zhang_later', 'ParentChild', 'High', '张皇后为张飞次女。', 'manual_curated'),
('empress_zhang_later', 'zhang_fei', 'ParentChild', 'High', '张皇后为张飞次女。', 'manual_curated'),
('zhang_fei', 'zhang_xingcai', 'ParentChild', 'Medium', '张星彩为后世三国题材塑造的张飞之女。', 'manual_curated'),
('zhang_xingcai', 'zhang_fei', 'ParentChild', 'Medium', '张星彩为后世三国题材塑造的张飞之女。', 'manual_curated'),

('zhuge_liang', 'zhuge_jin', 'Sibling', 'High', '诸葛瑾为诸葛亮之兄。', 'manual_curated'),
('zhuge_jin', 'zhuge_liang', 'Sibling', 'High', '诸葛瑾为诸葛亮之兄。', 'manual_curated'),
('zhuge_liang', 'zhuge_jun', 'Sibling', 'High', '诸葛均为诸葛亮之弟。', 'manual_curated'),
('zhuge_jun', 'zhuge_liang', 'Sibling', 'High', '诸葛均为诸葛亮之弟。', 'manual_curated'),
('zhuge_liang', 'zhuge_zhan', 'ParentChild', 'High', '诸葛瞻为诸葛亮之子。', 'manual_curated'),
('zhuge_zhan', 'zhuge_liang', 'ParentChild', 'High', '诸葛瞻为诸葛亮之子。', 'manual_curated'),
('zhuge_zhan', 'zhuge_shang', 'ParentChild', 'High', '诸葛尚为诸葛瞻之子。', 'manual_curated'),
('zhuge_shang', 'zhuge_zhan', 'ParentChild', 'High', '诸葛尚为诸葛瞻之子。', 'manual_curated'),
('zhuge_jin', 'zhuge_ke', 'ParentChild', 'High', '诸葛恪为诸葛瑾之子。', 'manual_curated'),
('zhuge_ke', 'zhuge_jin', 'ParentChild', 'High', '诸葛恪为诸葛瑾之子。', 'manual_curated'),
('zhuge_jin', 'zhuge_rong', 'ParentChild', 'High', '诸葛融为诸葛瑾之子。', 'manual_curated'),
('zhuge_rong', 'zhuge_jin', 'ParentChild', 'High', '诸葛融为诸葛瑾之子。', 'manual_curated'),

('sima_yi', 'sima_shi', 'ParentChild', 'High', '司马师为司马懿之子。', 'manual_curated'),
('sima_shi', 'sima_yi', 'ParentChild', 'High', '司马师为司马懿之子。', 'manual_curated'),
('sima_yi', 'sima_zhao', 'ParentChild', 'High', '司马昭为司马懿之子。', 'manual_curated'),
('sima_zhao', 'sima_yi', 'ParentChild', 'High', '司马昭为司马懿之子。', 'manual_curated'),
('sima_shi', 'sima_zhao', 'Sibling', 'High', '司马师与司马昭为兄弟。', 'manual_curated'),
('sima_zhao', 'sima_shi', 'Sibling', 'High', '司马师与司马昭为兄弟。', 'manual_curated'),
('sima_zhao', 'sima_yan', 'ParentChild', 'High', '司马炎为司马昭之子。', 'manual_curated'),
('sima_yan', 'sima_zhao', 'ParentChild', 'High', '司马炎为司马昭之子。', 'manual_curated'),

('yuan_shao', 'yuan_tan', 'ParentChild', 'High', '袁谭为袁绍长子。', 'manual_curated'),
('yuan_tan', 'yuan_shao', 'ParentChild', 'High', '袁谭为袁绍长子。', 'manual_curated'),
('yuan_shao', 'yuan_shang', 'ParentChild', 'High', '袁尚为袁绍之子。', 'manual_curated'),
('yuan_shang', 'yuan_shao', 'ParentChild', 'High', '袁尚为袁绍之子。', 'manual_curated'),

('ma_teng', 'ma_chao', 'ParentChild', 'High', '马超为马腾之子。', 'manual_curated'),
('ma_chao', 'ma_teng', 'ParentChild', 'High', '马超为马腾之子。', 'manual_curated'),
('dong_zhuo', 'dong_bai', 'ParentChild', 'High', '董白为董卓孙女。', 'manual_curated'),
('dong_zhuo', 'dong_min', 'Sibling', 'High', '董旻为董卓之弟。', 'manual_curated'),
('dong_min', 'dong_zhuo', 'Sibling', 'High', '董旻为董卓之弟。', 'manual_curated'),
('lu_bu', 'lu_lingqi', 'ParentChild', 'Medium', '吕玲绮为后世三国题材塑造的吕布之女。', 'manual_curated'),

('liu_zhang', 'ctk_5218_7109', 'ParentChild', 'High', '刘璋为刘焉之子。', 'manual_curated'),
('shi_xie', 'shi_hui_jiaozhou', 'ParentChild', 'Medium', '士徽为士燮之子。', 'manual_curated'),
('shi_xie', 'shi_yi_jiaozhou', 'Sibling', 'Medium', '士壹为士燮之弟。', 'manual_curated'),
('shi_yi_jiaozhou', 'shi_xie', 'Sibling', 'Medium', '士壹为士燮之弟。', 'manual_curated'),
('shi_xie', 'shi_wei_jiaozhou', 'Sibling', 'Medium', '士䵋为士燮之弟。', 'manual_curated'),
('shi_wei_jiaozhou', 'shi_xie', 'Sibling', 'Medium', '士䵋为士燮之弟。', 'manual_curated'),
('shi_xie', 'shi_wu_jiaozhou', 'Sibling', 'Medium', '士武为士燮之弟。', 'manual_curated'),
('shi_wu_jiaozhou', 'shi_xie', 'Sibling', 'Medium', '士武为士燮之弟。', 'manual_curated');
