...
pub(super) struct GameUiState {
    ...
    pub(super) retainer_selected_id: Option<OfficerId>,
    ...
    pub(super) turn_summary_open: bool,
    pub(super) turn_summary_report_index: Option<usize>,
    pub(super) save_panel_open: bool,
    pub(super) return_main_menu_confirm_open: bool,
    ...
    pub(super) selected_diplomacy_action: DiplomacyActionKind,
    pub(super) selected_diplomacy_source_city: Option<CityId>,
    pub(super) selected_diplomacy_receive_city: Option<CityId>,
    pub(super) diplomacy_offer: ResourceBundle,
    pub(super) diplomacy_request: ResourceBundle,
...
impl GameUiState {
    pub(super) fn new(
        ...
        Self {
            ...
            turn_summary_report_index: None,
            save_panel_open: false,
            return_main_menu_confirm_open: false,
            ...
            selected_diplomacy_action: DiplomacyActionKind::ImproveRelations,
            selected_diplomacy_source_city: None,
            selected_diplomacy_receive_city: None,
            diplomacy_offer: ResourceBundle::default(),
            diplomacy_request: ResourceBundle::default(),
            save_manager,
            autosave_meta,
            save_slots,
