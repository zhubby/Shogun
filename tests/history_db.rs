...
fn historical_relationships_include_curated_family_and_enemy_links() {
    ...
    for (source, target, kind) in [
        ...
        ("cao_pi", "cao_rui", OfficerRelationshipKind::ParentChild),
        ("sun_quan", "sun_deng", OfficerRelationshipKind::ParentChild),
        ("sun_he", "sun_hao", OfficerRelationshipKind::ParentChild),
        (
            "liu_bei",
            "liu_feng",
            OfficerRelationshipKind::AdoptiveParentChild,
        ),
        ("guan_yu", "guan_xing", OfficerRelationshipKind::ParentChild),
        ("guan_xing", "guan_yu", OfficerRelationshipKind::ParentChild),
        ("zhuge_liang", "zhuge_jin", OfficerRelationshipKind::Sibling),
        (
            "zhuge_zhan",
            "zhuge_shang",
            OfficerRelationshipKind::ParentChild,
        ),
        ("sima_yi", "sima_shi", OfficerRelationshipKind::ParentChild),
        ("sima_shi", "sima_yi", OfficerRelationshipKind::ParentChild),
        (
            "sima_zhao",
            "sima_yan",
            OfficerRelationshipKind::ParentChild,
        ...
        ("ma_teng", "ma_chao", OfficerRelationshipKind::ParentChild),
        (
            "dong_zhuo",
            "dong_bai",
            OfficerRelationshipKind::ParentChild,
        ),
        ("lu_bu", "lu_lingqi", OfficerRelationshipKind::ParentChild),
        (
            "liu_zhang",
            "ctk_5218_7109",
            OfficerRelationshipKind::ParentChild,
